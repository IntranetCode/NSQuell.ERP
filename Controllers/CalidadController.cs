...
namespace ERP.NSQuell.Controllers
{
    public class CalidadController : Controller
    {
        ...
        public async Task<IActionResult> Detalle(int id)
        {
            ...
            var model =
                new CalidadDetalleViewModel
                {
                    InspeccionID =
                        inspeccion.InspeccionID,

                    ProgramaProduccionID =
                        inspeccion.ProgramaProduccionID,
                    ...
                    ReleaseID =
                        inspeccion.ReleaseID,

                    ReleaseDetalleID =
                        inspeccion.ReleaseDetalleID,
                    ...
                    CodigoBarras =
                        inspeccion.CodigoBarras,

                    OrdenTrabajo =
                        inspeccion.OrdenTrabajo,
                    ...
                    CantidadTotal =
                        inspeccion.CantidadTotal,

                    CantidadRevisada =
                        inspeccion.CantidadRevisada,

                    CantidadPendiente =
                        inspeccion.CantidadPendiente,
                    ...
                    UsuarioNotificoID =
                        inspeccion.UsuarioNotificoID,

                    FechaAutorizacionPrearranque =
                        inspeccion
                            .FechaAutorizacionPrearranque,

                    UsuarioAutorizacionPrearranqueID =
                        inspeccion
                            .UsuarioAutorizacionPrearranqueID,
                    ...
                    ValidacionDimensional =
                        inspeccion
                            .ValidacionDimensional,

                    ValidacionApariencia =
                        inspeccion
                            .ValidacionApariencia,
                    ...
                    ValidacionConductividad =
                        inspeccion
                            .ValidacionConductividad,

                    FechaValidacionPrimerasPiezas =
                        inspeccion
                            .FechaValidacionPrimerasPiezas,

                    UsuarioValidacionPrimerasPiezasID =
                        inspeccion
                            .UsuarioValidacionPrimerasPiezasID,
                    ...
                    Historial =
                        inspeccion.Historial
                            .OrderByDescending(x =>
                                x.FechaMovimiento)
                            .Select(x =>
                                new CalidadHistorialItemViewModel
                                {
                                    HistorialID =
                                        x.HistorialID,
